// https://github.com/cloudflare/workers-graphql-server/blob/master/src/handlers/playground.js

import { Context } from "hono";

const playgroundHtml = (baseEndpoint: string) => `
<!DOCTYPE html>
<html>
  <head>
    <meta charset=utf-8 />
...
const playground = async (c: Context) => {
  return c.html(playgroundHtml("/graphql"));
};
